...
<div class="notebook_form">
    ...
    <form  method="post">
        <div class="mb-3">
            <input type="hidden" name="id" value="<?= $USER_UPDATE['id'] ?>" class="form-control "
        ...
        <div class="mb-3">
            ...
            <input type="text" name="name" value="<?= $USER_UPDATE['name'] ?>" class="form-control"
                   id="exampleInputEmail1"
                   aria-describedby="emailHelp">
        </div>
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Введите телефон</label>
            <input type="tel" name="phone" value="<?= $USER_UPDATE['phone'] ?>" class="form-control  input_phone"
                   id="exampleInputEmail1"
                   aria-describedby="emailHelp">
        </div>
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Адрес электронной почты</label>
            <input type="email" name="email" value="<?= $USER_UPDATE['email'] ?>" class="form-control"
                   id="exampleInputEmail1"
                   aria-describedby="emailHelp">
        </div>
        <div class="mb-3">
            ...
            <textarea type="text" name="note" value="" class="form-control"
                      id="exampleInputPassword1"><?= $USER_UPDATE['note'] ?></textarea>
        </div>
