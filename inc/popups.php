...
<div class="popups_inner">
    ...
    <div class="popup">
        <form class="popups_form" action="../index.php" method="post">
            ...
            <input type="text" name="phone" placeholder="phone" required="Поле не должно быть пустым" >
            <input type="email" name="email" placeholder="email" required="Поле не должно быть пустым" >
            <textarea type="text" name="note" placeholder="note" required="Поле не должно быть пустым" ></textarea>
